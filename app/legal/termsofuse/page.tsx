  ...
  return (
    <div className="wrapper">
      ...
      <p>
        ...
        conditions. Do not continue to use Metflix if you do not agree to take
      ...
      <p>
        We employ the use of cookies. By accessing Metflix, you agreed to use
        cookies in agreement with the Metflix's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Metflix and/or its licensors own the
        intellectual property rights for all material on Metflix. All
        intellectual property rights are reserved. You may access this from
        Metflix for your own personal use subjected to restrictions set in these
        terms and conditions.
      </p>

      <p>You must not:</p>
      <ul>
        <li>Republish material from Metflix</li>
        <li>Sell, rent or sub-license material from Metflix</li>
        <li>Reproduce, duplicate or copy material from Metflix</li>
        <li>Redistribute content from Metflix</li>
      </ul>
      ...
      <p>
        ...
        Metflix does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of Metflix,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Metflix shall not be liable for the
      ...
      <p>
        Metflix reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant Metflix a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of Metflix; and (d) the link is in
      ...
      <p>
        ...
        e-mail to Metflix. Please include your name, your organization name,
      ...
      <p>
        No use of Metflix's logo or other artwork will be allowed for linking
