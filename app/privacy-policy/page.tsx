  ...
  return (
    <div className="mt-16 flex flex-col gap-6">
      <section>
        ...
        <p className="mb-4">Last updated: March 13, 2023</p>
        <p className="mb-3">
      ...
      <section>
        ...
        <h2 className="my-4 text-lg font-semibold">Interpretation</h2>
        <p className="mb-3">
        ...
        <h2 className="my-4 text-lg font-semibold">Definitions</h2>
        ...
        <ul className="list-disc pl-8">
          ...
          <li>
            <p className="mb-3">
              ...
              in this Agreement) refers to Metflix.
            </p>
          </li>
          <li>
            <p className="mb-3">
      ...
      <section>
        ...
        <h2 className="my-4 text-lg font-semibold">Types of Data Collected</h2>
        <h3 className="mb-4 text-lg font-semibold">Personal Data</h3>
        <p className="mb-3">
        ...
        <h3 className="mb-4 text-lg font-semibold">Usage Data</h3>
        <p className="mb-3">
        ...
        <h3 className="mb-4 text-lg font-semibold">Business Transactions</h3>
        <p className="mb-3">
        ...
        <h3 className="mb-4 text-lg font-semibold">Law enforcement</h3>
        <p className="mb-3">
          Under certain circumstances, the Company may be required to disclose
          Your Personal Data if required to do so by law or in response to valid
          requests by public authorities (e.g. a court or a government agency).
        </p>
        <h3 className="mb-4 text-lg font-semibold">Other legal requirements</h3>
        <p className="mb-3">
      ...
      <section>
        <h1 className="mb-1 text-2xl font-bold">Children's Privacy</h1>
        <p className="mb-3">
      ...
      <section>
        <h1 className="mb-1 text-2xl font-bold">Links to Other Websites</h1>
        <p className="mb-3">
      ...
      <section>
        ...
        <ul className="list-disc pl-8">
          <li>By email: makadsuhel11@gmail.com</li>
        </ul>
      </section>
    </div>
  );
