  ...
  return (
    <section className="relative -mx-3 max-h-[85vh] overflow-hidden md:-mx-4 lg:-mx-6 2xl:-mx-8">
      <div className="absolute inset-0">
        <header className="absolute bottom-1/3 left-0 right-0 z-10 w-[42rem] max-w-full px-8">
          <h1 className="mb-2 text-3xl font-bold drop-shadow-[0_25px_25px_rgb(0,0,0)] md:text-4xl md:drop-shadow-none 2xl:text-5xl">
            {title}
          </h1>
